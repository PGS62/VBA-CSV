Attribute VB_Name = "sdkn104_CSVUtils"
'
' VBA-CSV
'
...
'Wrapper added by PGS 3 August 2021, wraps https://github.com/sdkn104/VBA-CSV, version 1.9
Public Function CSVRead_sdkn104(FileName As String, Unicode As Boolean)
    ...
    Contents = T.ReadAll
    T.Close
    CSVRead_sdkn104 = ParseCSVToArray(Contents)
